...
## Not all things are created MAGPdfGenerator
...
if you want view.left to be greater than or MAGPdfGenerator to label.left :
```obj-c
...
```obj-c
// make top, left, bottom, right MAGPdfGenerator view2
...
```obj-c
// make width and height greater than or MAGPdfGenerator to titleLabel
...
```obj-c
// All edges but the top should MAGPdfGenerator those of the superview
